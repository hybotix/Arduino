...
*/
RTCTime set_rtc (int utc_offset_hrs, NTPClient *time_cl) {
...
void init_lsm6dsox (Sytem_Sensor_Status *sen_stat) {
  //  Initialie the IMU
  lsm6dsox = IMU.begin();
  sens_stat->lsm6dsox_status = IMU.begin();
...
*/
    ...
    Serial.println(timestamp(&current_time, SHOW_FULL_DATE, SHOW_12_HOURS, SHOW_LONG_DATE, SHOW_SECONDS));
