...
String set_empty_page (uint16_t sequence_nr, String page_name) {
  String date_time, html;

  html =  PAGE_HTML[PAGE_NO_DATA]; //String(HTML_CONTENT_ENVIRONMENT);
  date_time = timestamp(&mux, &rtc, MUX_TCA9548A_PORT, SHOW_FULL_DATE, SHOW_12_HOURS, SHOW_LONG_DATE, SHOW_SECONDS);
  Serial.println(PAGE_NO_DATA_NAME);
  html.replace("PAGE_NAME_MARKER", page_name);
        ...
        switch (page_id) {
          ...
          case PAGE_ENVIRONMENT:
            ...
            if ( !(sensor_status.sht45 and sensor_status.scd40 and sensor_status.ens160)) {
              ...
              set_empty_page(sequence_nr, PAGE_ENVIRONMENT_NAME);
            }
            break;
          case PAGE_SWITCHES:
          ...
          case PAGE_LIGHT:
            ...
            if (USING_VEML7700 and sensor_status.veml7700) {
              ...
              //  Empty page
              set_empty_page(sequence_nr, PAGE_LIGHT_NAME);
            }
            break;
          case PAGE_IMU:
            ...
            if (USING_BNO055 and sensor_status.bno055) {
              ...
              if (! (sensor_status.lsm6dsox_9dof and sensor_status.lsm6dsox_6dof and sensor_status.bno055)) {
                //  Empty page
              html = set_empty_page(sequence_nr, PAGE_IMU_NAME);
              }
            }
