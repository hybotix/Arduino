...
#define PAGE_IMU_BNO055               (GET_PAGE_BASE + 5)
#define PAGE_IMU_BNO055_TITLE         "Robot Smart Home Controller: BNO055 IMU"
#define PAGE_IMU_BNO055_NAME          PAGE_NO_DATA_TITLE

#define PAGE_IMU_LSM6DSOX             (GET_PAGE_BASE + 6)
#define PAGE_IMU_LSM6DSOX_TITLE       "Robot Smart Home Controller: LSM6DSOX IMU"
#define PAGE_IMU_LSM6DSOX_NAME        PAGE_IMU_LSM6DSOX_TITLE

#define PAGE_NO_DATA                  (GET_PAGE_BASE + 7)
#define PAGE_NO_DATA_TITLE            "Robot Smart Home Controller: NO DATA AVAILABLE"
#define PAGE_NO_DATA_NAME             PAGE_NO_DATA_TITLE

//  MUST always be one more than the last defined page
#define MAX_NUM_PAGES                 (PAGE_NO_DATA)
