...
void RSHC_Print::RSHC_Print(void) {
  //  Constructor (empty for this example)
}

void RSHC_Print::print_switch_states (uint8_t nr_of_switches=NUMBER_OF_SWITCHES) {
  uint8_t index;
...
void RSHC_Print::print_uint_16_hex(uint16_t value) {
...
void RSHC_Print::print_sensor_stat (bool available, String name) {
  if (available) {
...
void RSHC_Print::print_full_sensor_status(System_Sensor_Status *sen_stat) {
  Serial.println();
...
void RSHC_Print::bno55_print_event (sensors_event_t* event) {
...
*/
void RSHC_Print::print_wifi_status(void) {
